...
/**
 * AccountCircle2Line icon from Remix Icon
 * @module
 */
export function RiAccountCircle2Line(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default RiAccountCircle2Line;
